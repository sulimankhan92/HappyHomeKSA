            ...
            <div class="page-title">
                <div class="row">
                    <div class="col-sm-6 ps-0">
                        <h3>{{ __('Create') }} Supplier Account</h3>
                    </div>
...
{{--                        <h1 class="text-base font-semibold leading-6 text-gray-900">{{ __('Create') }} Supplier</h1>--}}
{{--                        <p class="mt-2 text-sm text-gray-700">Add a new {{ __('Supplier') }}.</p>--}}
{{--                    </div>--}}
