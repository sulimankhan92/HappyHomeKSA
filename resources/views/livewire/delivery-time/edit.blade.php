            ...
            <div class="w-full">
                <div class="sm:flex sm:items-center">
                    <div class="sm:flex-auto">
                        <h1 class="text-base font-semibold leading-6 text-gray-900">{{ __('Update') }} Delivery Time</h1>
                        <p class="mt-2 text-sm text-gray-700">Update existing {{ __('Delivery Time') }}.</p>
                    </div>
