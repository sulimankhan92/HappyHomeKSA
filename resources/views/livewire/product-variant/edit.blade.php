            ...
            <div class="w-full">
                <div class="sm:flex sm:items-center">
                    <div class="sm:flex-auto">
                        <h1 class="text-base font-semibold leading-6 text-gray-900">{{ __('Update') }} Product Variant</h1>
                        <p class="mt-2 text-sm text-gray-700">Update existing {{ __('Product Variant') }}.</p>
                    </div>
                    ...
                    <div class="mt-8 overflow-x-auto">
                        <div class="max-w-xl py-2 align-middle">
                            <form method="POST" wire:submit="save" role="form" enctype="multipart/form-data">
                                {{ method_field('PATCH') }}
                                @csrf
                                @include('livewire.product-variant.form')
                            </form>
                        </div>
                    </div>
                </div>
