...
{{--    </div>--}}
{{--    <div>--}}
{{--        <label for="image">order_number:</label>--}}
{{--        <input type="number" name="order_number" id="order_number" value="{{ $banner->order_number }}" required>--}}
{{--    </div>--}}
{{--    <div>--}}
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('banners.update', $banner->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="space-y-6">
                                        <div>
                                            <img src="{{ asset('storage/app_banner/' . $banner->image) }}" width="80px"/>
                                        </div>
                                        <div class="mb-3">
                                            <x-input-label for="image" value="Image"/>
                                            <x-text-input id="image" name="image" type="file" class="form-control" value="image" />
                                            @error('image')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="number" class="form-control" name="order_number" id="order_number" value="{{ $banner->order_number }}" required>
                                            @error('order_number')
                                            <x-input-error class="mt-2" :messages="$message"/>
                                            @enderror
                                        </div>
