            ...
            <div class="row">
                ...
                <div class="col-sm-6 pe-0">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"> {{ __('Update') }} Categories</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <x-alert />
                            <form method="POST" role="form" action="{{ route('categories.update', $category->id) }}" role="form" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
