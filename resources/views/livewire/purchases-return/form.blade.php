<div class="space-y-6">
    ...
    <div>
        <x-input-label for="invoice_no" :value="__('Invoice No')"/>
        <x-text-input wire:model="form.invoice_no" id="invoice_no" name="invoice_no" type="text" class="mt-1 block w-full" autocomplete="invoice_no" placeholder="Invoice No"/>
    ...
    <div>
        ...
        <x-text-input wire:model="form.invoice_date" id="invoice_date" name="invoice_date" type="text" class="mt-1 block w-full" autocomplete="invoice_date" placeholder="Invoice Date"/>
